...
class ImageGenerator:
    ...
    def populate_image(self, noise_array, debug=False, lambda_array=ImageUtils.demo_lambda_arrays[0],
                       colour_order=["r", "g", "b"]):
        ...
        custom_arrays = ImageUtils.get_custom_arrays_from_noise([noise_array], lambda_array)

        for x in range(self.image.size[0]):
            for y in range(self.image.size[1]):
                try:
                    r = custom_arrays[colour_order.index("r")][x // trans_mult_x, y // trans_mult_y]
                    g = custom_arrays[colour_order.index("g")][x // trans_mult_x, y // trans_mult_y]
                    b = custom_arrays[colour_order.index("b")][x // trans_mult_x, y // trans_mult_y]
                    pixels[x, y] = (r, g, b)
